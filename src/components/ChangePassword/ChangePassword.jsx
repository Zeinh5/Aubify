...
const ChangePassword = () => {
  ...
  const checkCurrentPassword = async (password) => {
    try {
      const email = localStorage.getItem('userEmail');
      const response = await axios.post('https://aubify.vercel.app/checkCurrentPassword', { email, password });
  ...
  const saveNewPassword = async (email, newPassword) => {
    try {
      await axios.post('https://aubify.vercel.app/saveNewPassword', { email, newPassword });
